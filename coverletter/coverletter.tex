% arara: lualatex: { options: ['--jobname=FabianGublerCoverLetter'] }
...
\name{Fabian}{Gubler}
\position{Full Stack Developer{\enskip\cdotp\enskip}Data Engineer}
\address{Rotackerstrasse 6, 8266 Steckborn, Switzerland}
